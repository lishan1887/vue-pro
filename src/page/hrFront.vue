<template>
  <div class="BPMlist">
    <div class="head">
      ...
      <h1 class="headHr" >人力驾驶舱</h1>
      <div class="headTime" >{{ time }}</div>
    </div>
...
export default {
  ...
  methods: {
            ...
            itemStyle: {
              ...
              normal: {
                ...
                color: this.$echarts.graphic.LinearGradient(0, 0, 0, 1, [
                  { offset: 0, color: "#FFF6A1" },
                  { offset: 1, color: "#FFB745" },
                ]),
              },
            },
          },
    ...
    // 商机
     businessLine () {
      //初始化容器
      let myChart = this.$echarts.init(this.$refs["business"]);
      //初始化图标配置选项
      let option = {
        grid: {
          x: 40,
     ...
     perCapitaBar () {
      //初始化容器
      let myChart = this.$echarts.init(this.$refs["perCapitaIncome"]);
      //初始化图标配置选项
      let option = {
        grid: {
          x: 35,
...
.chainMiddle{
  ...
  height: 242px;
  margin-top: -130px;
  background: url("../assets/hrFront/chainMiddle.png") center;
  background-size: 100% 100%;
  text-align: center;
  line-height: 300px;
}
...
.scienceNum{
  width: 200px;
  height: 200px;
  background: url("../assets/hrFront/scienceLeft.png") center;
  background-size: 100% 100%;
  text-align: center;
  line-height: 250px;
}
...
.chainRight{
  ...
  height: 62px;
  margin-top: -40px;
  background: url("../assets/hrFront/chainRight.png") center;
  background-size: 100% 100%;
}
.headDate{
  font-family: PingFangSC-Regular;
